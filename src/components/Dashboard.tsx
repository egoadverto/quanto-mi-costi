  ...
  return (
    <section id="dashboard" className="space-y-3">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="stat-card"><p className="stat-label">Veicolo più costoso</p><p className="text-sm font-semibold text-[var(--text-primary)]">{dashboard.costoPerVeicolo ? dashboard.costoPerVeicolo.nome : 'N/D'}</p></div>
