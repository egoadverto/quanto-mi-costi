      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="panel-highlight p-5">
          ...
          <form onSubmit={onSubmit} className="grid gap-3 sm:grid-cols-2">
            ...
            <input className="app-input w-full" placeholder="Data acquisto" type="date" value={form.data_acquisto} onChange={(e) => onFormSet({ ...form, data_acquisto: e.target.value })} />
            <input className="app-input w-full" placeholder="Km iniziali" type="number" value={form.km_iniziali} onChange={(e) => onFormSet({ ...form, km_iniziali: e.target.value })} />
